// Ini adalah client component untuk halaman absensi

// Tugas:
// - Copy paste SELURUH code absensi lama ke sini
// - Jangan ubah logic apapun
// - Pastikan tetap pakai "use client"

// Komponen ini hanya berisi UI dan logic absensi
// Tidak perlu handle login atau auth di sini
...
export default function AbsenClient() {
  ...
  const url =
    "https://script.google.com/macros/s/AKfycbxMWGCg5BQ2h7IDnJncDSABDKG0VMflY0DHdmz0LBY5J34RPyLsTQNn-TDf-_YD5Ur32Q/exec";
